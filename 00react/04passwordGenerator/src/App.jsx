...
// ____________________________________New_________________________________
...
function App() {
  ...
  const passwordGenerator = useCallback(()=>{
    let pass = "";
    let str = "ABCDEabcde";
    if(numberAllowed) str += "0123478956";
    if(charAllowed) str += "@#$&*";
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-700">
      ...
      <div className='flex text-sm gap-x-2'>
        ...
        <div className='flex items-center gap-x-1'>
          ...
          />
          <label htmlFor="numberAllowed">Numbers: {numberAllowed} </label>
        </div>
        <div className='flex items-center gap-x-1'>
          <input 
          type="checkbox"
